    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enviarnumero.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(phoneNumber)){
                    Toast.makeText(LoginActivity.this, "¡Primero debes ingresar tu número!", Toast.LENGTH_SHORT).show();
                }else{
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(@NonNull FirebaseException e) {
                dialog.dismiss();
                Toast.makeText(LoginActivity.this, "El inicio ha fallado, puede ser por: \n1. Número inválido \n2. No tiene conexión a internet", Toast.LENGTH_SHORT).show();
            ...
            public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken token) {
                ...
                dialog.dismiss();
                Toast.makeText(LoginActivity.this, "Su código ha sido enviado!", Toast.LENGTH_SHORT).show();
                numero.setVisibility(View.GONE);
                enviarnumero.setVisibility(View.GONE);
        ...
        auth.signInWithCredential(credential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    dialog.dismiss();
                    Toast.makeText(LoginActivity.this, "Ingresado con éxito", Toast.LENGTH_SHORT).show();
                    EnviaralaPrincipal();
                }else
                {
